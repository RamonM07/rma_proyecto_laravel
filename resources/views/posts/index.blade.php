  ...
  <div class="container">
    <h1 class="h1 alert alert-primary text-center">Publicaciones</h1>
      ...
      <div class="row g-5 d-flex justify-content-center">
        <div class="col-3">
          <figure class="figure">
              <img src="{{asset('images/undraw_chasing_love_re_9r1c.svg')}}" alt="ethe" class="figure-img img-fluid" style="width:200%">
          </figure>
        </div>
        <div class="col-8">
        <a href="{{url('publicaciones/create')}}" class="btn btn-dark mb-4 text-white"data-toggle="tooltip" title="Insertar nueva reaccion"><span class="icon-pen"> Nuevo</span></a>
            <table class="table card" style="background: #e1e1e8">
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('publicaciones.edit',$posts->id)}}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Editar reaccion"><span class="icon-compose">Editar</span></a></td>
                            <td><form action="{{route('publicaciones.destroy',$posts->id)}}" method="post">
                              @csrf
                              @method('delete')
