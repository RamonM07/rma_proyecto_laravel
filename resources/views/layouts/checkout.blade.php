...
<head>
    ...
    <script type="text/text/javascript"src="{{asset("js/bootstrap.bundle.min.js")}}"></script>
</head>
<body class="bg-light">
<div class="container">
    <main>
        ...
        <figure class="figure">
            <img class="d-block mx-auto mb-4" src="{{asset("img/booststrap.jpg")}}" alt="" width="72" height="57"
                 class="figure-img img-fluid" class="figure-img img-fluid" alt="imagen">
        </figure>
            <h1>Checkout form</h1>
        ...
        <div class="row g-5">
            <div class="col-md-5 col-lg-4 order-md-last">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <div>
                            <h4 class="my-0">Second product</h4>
                            <small class="text-muted">Brief description</small>
                        </div>
            ...
            <div class="col-md-7 col-lg-8">
                <h7 class="mb-3">Billing address</h7>
